...
CREATE PROCEDURE USP_KIEMTRA_TTGH @MA_KHACH_HANG CHAR(5), @MA_DON CHAR(5)
AS
BEGIN TRAN
...
CREATE PROCEDURE USP_TX_CAPNHAT_TTGH @MA_TAI_XE CHAR(5), @MA_DON CHAR(5), @TTGH NVARCHAR(255)
AS
BEGIN TRAN
	UPDATE DONDATHANG
	SET TINH_TRANG = @TTGH
