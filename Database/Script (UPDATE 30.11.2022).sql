...
CREATE DATABASE Ql_DATHANG_BANHANG_DEMO
GO
USE Ql_DATHANG_BANHANG_DEMO
GO

CREATE TABLE CUAHANG(
    MA_CUA_HANG CHAR(8) NOT NULL,
...
CREATE TABLE HOPDONG(
    MA_HOP_DONG CHAR(8) NOT NULL,
	NGAY_TAO  DATETIME,
	TG_BAT_DAU DATETIME,
	TG_KET_THUC DATETIME,
	MA_CUA_HANG CHAR(8),--khóa ngoại
	STK CHAR(12),--khóa ngoại
	MA_NHAN_VIEN CHAR(8), -- NHÂN VIÊN PHÊ DUYỆT HỢP ĐỒNG 
...
CREATE TABLE DONDATHANG(
	...
	NGAY_TAO DATETIME
	CONSTRAINT DONDATHANG_PK PRIMARY KEY(MA_DON)
)
...
VALUES  ('CH001',N'KFC','KFC@GMAIL.COM','TPHCM',N'QUẬN 5','1012647838',2,'RONALDO','MT001',1),
		...
		('CH004','KFC','KFC@GMAIL.COM','TPHCM',N'QUẬN 5','1012647838',2,'RONALDO','MT001',16),
...
VALUES('MA001','TEST1',N'có bán',100000,'CH001',1),
		('MA002','TEST2',N'có bán',110000,'CH002',1),
		('MA003','TEST3',N'có bán',200000,'CH003',1),
		('MA004',N'Cơm gà',N'có bán',100000,'CH001',1),
		('MA005',N'Bánh xèo',N'có bán',110000,'CH002',1),
		('MA006',N'Tà tưa',N'có bán',200000,'CH003',1),
		('MA008',N'Bánh gạo',N'có bán',100000,'CH001',1),
		('MA009',N'Bánh Ngọt',N'có bán',110000,'CH002',1),
		('MA010',N'Cocacola',N'có bán',200000,'CH003',1)
GO
...
GO
INSERT INTO MON_AN_CHI_NHANH VALUES ('MA001','CN001',100),
									('MA002','CN002',100)


GO
INSERT INTO DONDATHANG(MA_DON,TONG_TIEN,DIA_CHI,TINH_TRANG,PHI_VAN_CHUYEN,MA_KHACH_HANG,MA_TAI_XE,MA_CHI_NHANH,TRANG_THAI,NGAY_TAO)
VALUES('DH001',NULL,N'45 TÂN LẬP',NULL,90000,'KH001','TX001','CN003',1,'10/10/2022'),
		('DH002',NULL,N'45 TÂN LẬP',NULL,100000,'KH002','TX002','CN001',1,'11/10/2022'),
		('DH003',NULL,N'45 TÂN LẬP',NULL,100000,'KH002','TX003','CN007',1,'12/10/2022'),
		('DH005',NULL,N'45 TÂN LẬP',NULL,90000,'KH001','TX001','CN003',1,'1/9/2022'),
		('DH006',NULL,N'45 TÂN LẬP',NULL,1900000,'KH002','TX002','CN001',1,'2/8/2022'),
		('DH007',NULL,N'45 TÂN LẬP',NULL,1080000,'KH002','TX003','CN007',1,'3/7/2022')
